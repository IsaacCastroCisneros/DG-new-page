...
export default function HeroProduct(props) 
{
  ...
  return (
    ...
    >
      ...
      <div className="custom-container3 mob:!px-[.8rem] relative z-[20] flex gap-[3rem] heroProduct:gap-0 items-center py-[4.5rem] heroProduct:pt-[2rem] heroProduct:pb-0 h-[100%] heroProduct:flex-col">
        <HeroProductSection
