...
export default function WhatsButton({titulo,asesores}) 
{
  ...
  return (
    <a className='whatBtn fixed bottom-[1rem] right-[1rem] z-[9999] w-[3.5rem] elige:bottom-[.5rem] elige:right-[.5rem]' 
     ...
     >
       ...
       <p className='transition-all duration-200 absolute top-0 right-[0rem] text-myBlack text-[.8rem] translate-y-[-100%] min-w-[12rem] max-w-[12.5rem] bg-[#fff] border-[1px] border-gray-400 p-[.6rem] rounded-[.3rem] shadow-xl elige:text-[.7rem] elige:min-w-[10rem]'>
