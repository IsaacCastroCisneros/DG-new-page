  ...
  return (
    <div className='relative'
     ...
     >
      ...
      <div className='custom-container2 !py-[4rem] relative z-[99] text-[#fff]'>
        <strong className='text-[#fff] text-[2.5rem]'>
           Nuestros
        </strong>
        <h1 className='text-[#fff] text-[5rem] phone:text-[1.5rem] uppercase'>
